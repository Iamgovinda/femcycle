...
const PredictionLayer = () => {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await post(`/user/${user.username}/post-user-data/`, data);
    ...
    return (
        <>
            ...
            <Box>
                <Container>
                    <form onSubmit={handleSubmit(onSubmit, (errors) => console.log("Form submission errors:", errors))} autoComplete="off">
                        <Grid container spacing={0} marginTop={15}>
                            <Grid item lg={6} display='flex' flexDirection={'column'} gap={5}>
                                ...
                                <TextField
                                    ...
                                    label="Total Fertility Formula*"
                                    placeholder=""
                                    {...register('total_fertility_formula')}
                                ></TextField>
                                <TextField
                                    type="number"
                                    fullWidth
